"""Extracción de Stock de Capital, Depreciación y Capital Humano de Colombia desde PWT 11.0.
...
2. **PARSING**  — Lee el CSV crudo, filtra por ``countrycode == "COL"``,
   ...
   descarta filas sin valor en ``rnna`` y genera el DataFrame con esquema estándar.
